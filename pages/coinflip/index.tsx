			...
			<div className="flex min-h-full">
				...
				<div className="w-[calc(100%-5rem)] min-h-screen background lg:flex">
					<div>
						...
						<main className="lg:p-8 p-4 mt-4">
					...
					<aside className="bg-[#181B23] h-full lg:w-full mt-20 lg:mt-0 lg:pt-40 p-8 flex flex-col gap-20">
						<div className="bg-[#202531] flex flex-col gap-3 p-4 rounded-lg border-t-2 border-[#32394A]">
							...
							<button
								onClick={() =>
									NotificationManager.success("You started a game !")
								}
